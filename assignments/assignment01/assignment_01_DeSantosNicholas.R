...
week1_sleep[3] #assuming the week begins on Sunday and Tuesday is the 3rd day of the week

## Create a vector called `week1_sleep_weekdays`
## Assign the weekday values using indice slicing
week1_sleep_weekdays <- week1_sleep[2:6] #again assuming sunday is the start of the week
